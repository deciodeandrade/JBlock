                    ...
                    <li class="nav-item btn">
                        <article>
                            <a class="nav-link" href="/pessoas">
                                ...
                                <div className="titleButton">Pessoas</div>
                            </a>
                        </article>
                    </li>
                    <li class="nav-item btn">
                        <article>
                            <a class="nav-link" href="/relatorios">
                                ...
                                <div className="titleButton">Relatórios</div>
                            </a>
                        </article>
                    </li>
                    <li class="nav-item btn">
                        <article>
                            <a class="nav-link" href="/carrinhos">
                                ...
                                <div className="titleButton">Carrinhos</div>
                            </a>
                        </article>
                    </li>
                    <li class="nav-item btn">
                        <article>
                            <a class="nav-link" href="/compras">
                                ...
                                <div className="titleButton">Compras</div>
                            </a>
                        </article>
                    </li>
                    <li class="nav-item btn">
                        <article>
                            <a class="nav-link" href="/categorias">
                                ...
                                <div className="titleButton">Categorias</div>
                            </a>
                        </article>
                    </li>
                </ul>
