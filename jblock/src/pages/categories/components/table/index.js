...
class TableCategories extends Component {
    ...
    loadCategories = async (page = 1) => {
        ...
        this.setState({categories: docs, categoryInfo, page});
    };
        ...
        return (
            <div class="divTable">
                ...
                <div className="actions">
                    ...
                    <button disabled={page == categoryInfo.pages} onClick={this.nextPage} >Próximo</button>
                </div>
            </div>
        );
